...
public class SAT {
	...
	public static boolean tank_invincible(YelloTank tank, Invincible invincible) {
		boolean b1 = false;
		a00 = invincible.getX();
		a01 = invincible.getY();
		b00 = invincible.getX() + invincible.getWidth();
		b01 = invincible.getY();
		c00 = invincible.getX();
		c01 = invincible.getY() + invincible.getLength();
